...
- [Guide](https://stately.self.agency/guide/) — install the package, define stores, use SSR-safe managers, and configure plugins.
...
- [Testing and releases](https://stately.self.agency/guide/testing-and-releases) — contributor workflows, hooks, and release automation.

## Quick summary

Use Stately when you want one store model that scales from simple counters to product workflows with persistence, undo/redo, time travel, multi-tab coordination, and cancellable async actions.
